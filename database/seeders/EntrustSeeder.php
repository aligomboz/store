    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            ...
            $random_customer = User::create([
                ...
                'laset_name' => $faker->lastName,
                'username' => $faker->userName,
                'email' => $faker->unique()->safeEmail,
                'email_verified_at' => now(),
                'mobile' => '00972' . $faker->numberBetween('10000', '99999'),
                'password' => bcrypt(123123123),
                'status' => 1,
                'remember_token' => Str::random(10),
            ]);
        ...
        //Roles Main
        $manageMain = Permission::create(['display_name' => 'Main', 'name' => 'main', 'route' => 'index', 'module' => 'index', 'as' => 'index', 'icon' => 'fas fa-home', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '1',]);
