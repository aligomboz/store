    ...
    <div class="row">
        <div class="col-md-4 mb-4 mb-md-0">
            <a class="category-item" href="{{ route('frontend.shop', $product_categories[0]->slug) }}">
                <img class="img-fluid" src="{{ asset('assets/product_categories/' . $product_categories[0]->cover) }}"
                    alt="">
        ...
        <div class="col-md-4 mb-4 mb-md-0">
            <a class="category-item mb-4" href="{{ route('frontend.shop', $product_categories[1]->slug) }}">
                <img class="img-fluid" src="{{ asset('assets/product_categories/' . $product_categories[1]->cover) }}"
                    alt="">
                <strong class="category-item-title">Shoes</strong>
            </a>
            <a class="category-item" href="{{ route('frontend.shop', $product_categories[2]->slug) }}">
                <img class="img-fluid" src="{{ asset('assets/product_categories/' . $product_categories[2]->cover) }}"
                    alt="">
        ...
        <div class="col-md-4">
            <a class="category-item" href="{{ route('frontend.shop', $product_categories[3]->slug) }}">
                <img class="img-fluid" src="{{ asset('assets/product_categories/' . $product_categories[3]->cover) }}"
                    alt="">
