                ...
                <form action="{{ route('customer.update_profile') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center mb-4">
                            @if (auth()->user()->image != '')
                                <img src="{{ asset('assets/users/' . auth()->user()->image) }}" alt="{{ auth()->user()->full_name }}" class="img-thumbnail" width="120">
                                <div class="mt-2">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input class="form-control form-control-lg" name="laset_name" type="text" value="{{ old('laset_name', auth()->user()->laset_name) }}" placeholder="Enter your last name">
                            @error('laset_name')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-lg-6 form-group">
                        ...
                        <div class="col-lg-12 form-group">
                            <label class="text-small text-uppercase" for="image">Image</label>
