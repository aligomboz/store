    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.customers.update', $customer->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        <label for="laset_name">Last Name</label>
                        <input type="text" name="laset_name" value="{{ old('laset_name', $customer->laset_name) }}"
                            class="form-control">
            ...
            <div class="row pt-4">
                <div class="col-12">
                    ...
                    <div class="file-loading">
                        <input type="file" name="image" id="customer-image" class="file-input-overview">
...
<script>
    $(function () {
        $("#customer-image").fileinput({
            ...
            initialPreview: [
                @if($customer ->image != '')
                "{{ asset('assets/users/' . $customer->image) }}",
                @endif
            ],
