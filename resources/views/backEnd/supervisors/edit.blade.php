            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="laset_name" value="{{ old('laset_name', $supervisor->laset_name) }}"
                            class="form-control">
            ...
            <div class="row pt-4">
                <div class="col-12">
                    ...
                    <div class="file-loading">
                        <input type="file" name="image" id="supervisor-image" class="file-input-overview">
...
<script>
    $(function () {
        ...
        $("#supervisor-image").fileinput({
            ...
            initialPreview: [
                @if($supervisor -> image != '')
                "{{ asset('assets/users/' . $supervisor->image) }}",
                @endif
            ],
